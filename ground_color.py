...
def getGroundColor(img):
    ...
    cv2.imwrite("kmeans.png", ic2*255)
    ...
    mask = rangeToMask(pq,[[left/180,right/180]],[[left2/255,right2/255]],[[left3/255,right3/255]])
